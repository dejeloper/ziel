...
import { ModeToggle, DailyButton } from ".";
...
export function Navbar() {
  ...
  return (
    <nav className="bg-white dark:bg-gray-900 fixed top-0 w-full z-10 mb-24">
      <div className="flex items-center justify-between w-[92%] mx-auto p-4">
        ...
        <div
          className={cn(
            "md:static absolute bg-white dark:bg-gray-900 min-h-fit left-0 md:top-16 -top-full w-autoflex items-center px-5 py-2"
          )}
        >
